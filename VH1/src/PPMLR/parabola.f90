...
integer :: n, nmin, nmax
real(kind=8) :: onemfl
real(kind=8), dimension(maxsweep) :: a, deltaa, a6, al, flat, da, ar, diffa, scrch1, scrch2, scrch3
real(kind=8), dimension(maxsweep,5) :: para
...
integer :: n, nmin, nmax
real(kind=8), dimension(maxsweep,5) :: para
real(kind=8), dimension(maxsweep) :: dx, xa, a, b, c, d, ai, bi, ci
