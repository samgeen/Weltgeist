...
! LOCALS
INTEGER :: n
REAL(kind=8), DIMENSION(maxsweep) :: steep
REAL(kind=8) :: delp1, delp2, shock, temp1, temp2, old_flat
                                    ! use the numbers below for more aggresive flattening      
REAL(kind=8), PARAMETER :: omega1 = 0.75    ! 0.5    
REAL(kind=8), PARAMETER :: omega2 = 5.0     ! 10.0
REAL(kind=8), PARAMETER :: epsilon = 0.33   ! 1.00
