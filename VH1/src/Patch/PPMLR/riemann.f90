...
REAL(kind=8) :: gamma, gamfac1, gamfac2
REAL(kind=8), DIMENSION(maxsweep) :: plft, prgh, ulft, urgh, vlft, vrgh, wlft, wrgh, clft, crgh, zlft, zrgh
REAL(kind=8), DIMENSION(maxsweep) ::  umidl, umidr, pmid, umid, pmold, plfti, prghi

REAL(kind=8), PARAMETER :: smallp = 1.0e-25
